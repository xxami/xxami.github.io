...
project = 'We all love cats!'

# Change this to the tagline of your blog
tagline = 'Code, Artwork, etc.'

# Change this to the description of your blog
description = 'I\'m Lilah! Software developer/magical cat (it\'s all in the stars). This is where I pretend that i\'m super-active here by abusing github pages! I hope you\'ll enjoy my fab artwork and half-finished projects!'

# Change this to your name
author = 'lilah'

# Change this to your copyright string
copyright = '2038, ' + author

# Change this to your blog root URL (required for RSS feed)
website = 'https://xxami.github.io/blog/html/'
